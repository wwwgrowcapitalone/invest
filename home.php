<html>
   <head>
      ...
      <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.4/jquery.min.js"></script> 
      <script defer nonce="Q8Du3PPJ/Ovz+SU4JkEAefYTL0rI/lNbw5xSlw1+nS4=" nomodule src="assets/css/polyfills-c67a75d1b6f99dc8.js"></script>
                           ...
                           <div class="container web-align">
                              <div class="pos-rel" style="height:54px">
                                 <div class="valign-wrapper" style="height:60px">
                                    ...
                                    <div style="padding-right:11px;" class="valign-wrapper dashboardTabsText dashboardTabsTextActive"><a href="home.php" style="color: var(--green500);text-decoration: none;">Portfolio</a></div>
                                    <div style="padding-right:11px;" class="valign-wrapper dashboardTabsText"><a href="watchlist.php" style="color: var(--green500);text-decoration: none;">Watch List</a></div>
                                    <div style="padding-right:11px;" class="valign-wrapper dashboardTabsText"><a href="funds_add.php" style="color: var(--green500);text-decoration: none;">Funds</div>
                                    <div class="valign-wrapper dashboardTabsText"><a href="profile.php" style="color: var(--green500);text-decoration: none;">Profile</a></div>
                                 </div>
                              </div>
                           </div>
                        </div>
...
<div class="container-fluid">
  ...
  <ul class="nav nav-tabs">
    <li class="dropdown">
      <a class="dropdown-toggle" data-toggle="dropdown" href="#">Position</a>
      <ul class="dropdown-menu" style="padding: 6rem;">
	  <div class="seic76PricesDiv">
         </div>
        <!--<li><a href="#">NIFTY 50<br><span class="right-align contentPrimary bodyMedium14">19,310.15<span/>
		<span class="bodyMedium14 right-align contentNegative" style="margin-top: 0px;">-55.10 (0.28%)</span></a></li>
        <li><a href="#">SENSEX<br><span class="right-align contentPrimary bodyMedium14">164,948.66<span/>
		<span class="bodyMedium14 right-align contentNegative" style="margin-top: 0px;">-202.36 (0.31%)</span></a></li>
        <li><a href="#">BANKNIFTY<br><span class="right-align contentPrimary bodyMedium14">43,851.05<span/>
		<span class="bodyMedium14 right-align contentNegative" style="margin-top: 0px;">-40.30 (0.09%)</span></a></li> -->                      
      </ul>
    </li>
  </ul>
					 </div>
                           ...
                           <div class="col l12 fm77ProductsLinks">
                              <div class="col l3">
                                 <a href="/">
									...
									<img class="" src="logo.png" width="150" height="50" alt="Groww Logo"></div>
                                 </a>
