...
<html lang="en">
   ...
   <body>
      <div class="container-fluid" style="background-color: white;">
		 ...
		 <div class="et_pb_text_inner" style="box-shadow:0px 0px 3px 0px;padding-bottom: 30px;margin-top: 30px;">
            <h4 style="position: absolute;left: 100px;"><strong>Available Margin</strong></h4><br><br>
            <p style="position: absolute;left: 160px;font-size: 23px;font-weight: 600;">₹0</p><br><br><br><br>
			<span style="position: absolute;left: 100px;">Total Margin</span><span style="position: absolute;left: 200px;">₹0</span><br>
			<span style="position: absolute;left: 100px;">Used Margin</span><span style="position: absolute;left: 200px;">₹0</span>
		 </div>
		 <br><br>
		 <div class="btn bg-danger text-white" style="width:100%;"><a href="withdrawl.php" class="text-white">Withdraw</a></div>
		 
		 
         <div class="et_pb_text_inner">
            <h4><strong>Add Fund Now</strong></h4>
            <p><strong></strong></p>
         </div>
         <div class="tab" style="
            margin-bottom: 25rem;
            ">
            <button class="tablinks" onclick="openCity(event, 'Bank Transfer')">Bank Transfer</button>
            <button class="tablinks" onclick="openCity(event, 'UPI/Wallet Transfer')">UPI/Wallet transfer</button>
         </div>
               ...
               <table id="tablepress-4" class="tablepress tablepress-id-4 dataTable no-footer" role="grid">
                  <thead>
                     <tr class="row-1 odd" role="row">
                        <th class="column-2 sorting_disabled" rowspan="1" colspan="1">Bank Name</th>
                        <th class="column-3 sorting_disabled" rowspan="1" colspan="1">Account Number</th>
                        </tr>
                  </thead>
                  <tbody class="row-hover">
                     <tr class="row-2 even">
                        <td class="column-2">IDBI BANK (RAJASTHAN)</td>
                        <td class="column-3"> 1516104000071451</td>
                        </tr>
                  </tbody>
               </table>
               <table id="tablepress-4" class="tablepress tablepress-id-4 dataTable no-footer" role="grid">
                  <thead>
                        <tr class="row-1 odd" role="row">
                        <th class="column-4 sorting_disabled" rowspan="1" colspan="1">IFSC Code</th>
                        <th class="column-4 sorting_disabled" rowspan="1" colspan="1">ACCOUNT HOLDER NAME</th>
                     </tr>
                  </thead>
                  <tbody class="row-hover">
                           <tr class="row-2 even">
                        <td class="column-4">IBKL0001516</td>
                        <td class="column-4">LALA PUNJA PATEL</td>
                     </tr>
                  </tbody>
               </table>
            </div>
         </div>
         <div id="UPI/Wallet Transfer" class="tabcontent">
            <div class="et_pb_tab et_pb_tab_1 clearfix">
               <div class="et_pb_tab_content"><a href="#">growcapitalone@axl</a></div>
            </div>
         </div>
      </div>
      </div>
