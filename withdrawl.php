<html>
   ...
   <body>
      ...
      <div class="container-fluid">
         <div class="container">
            <div class="et_pb_text_inner" style="box-shadow:0px 0px 3px 0px;padding-bottom: 100px;margin-top: 30px;">
            <h4 style="position: absolute;left: 50px;"><strong>Withdrawal Money</strong></h4>
            <p style="position: absolute;left: 270px;font-size: 23px;font-weight: 600;">₹0</p><br><br><br><br>
			<input type="text" placeholder="No balance" style="position: relative;left: 45px;width: 150px;border: none;"><br>
			<span style="position: absolute;left: 65px;border-top: 1px solid black;border-bottom: 1px solid black;border-top-style: dashed;">1000+&nbsp;&nbsp;&nbsp;&nbsp; 2000+&nbsp;&nbsp;&nbsp;&nbsp; 3000+</span><br>
			<input type="text" name="number" placeholder="A/C No." style="position: absolute;left: 65px;width: 150px;margin-top: 15px;">
			<input type="text" name="number" placeholder="IFSC Code" style="position: absolute;left: 65px;width: 150px;margin-top: 55px;">
		 </div>
		 <div class="btn bg-danger text-white" style="width:100%;margin-top:20px;"><a href="home.php" class="text-white">Withdraw</a></div>
         </div>
      </div>
      <div class="row" style="height:138%;margin-top:10rem;">
