            ...
            <div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1">
               ...
               <div class="d-flex flex-center flex-column flex-lg-row-fluid">
                  ...
                  <div class="w-lg-500px p-10">
                     <!--begin::Form-->
                     <form action="#" method="POST" class="form w-100" novalidate="novalidate" id="kt_sign_in_form">
                        <!--begin::Heading-->
                        ...
                        <!--end::Input group--->  
						<input type="submit" name="login_btn" value="Login" class="btn btn-primary" style="width: 100%;margin-top: 2rem; background-image: linear-gradient(to right, red , Orange);">
                        <!--begin::Submit button-->
...
$query = "SELECT * FROM register_form_db WHERE Email = '$username' && Password = '$password' ";
...
if($total == 1)
{
	...
	<meta http-equiv = "refresh" content = "0; url = http://localhost/groww/home.php"/>
